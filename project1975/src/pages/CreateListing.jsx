    ...
    <form className='flex flex-col sm:flex-row gap-4'>
        ...
        <div className='flex flex-col flex-1 gap-4'>
            ...
            <div className='flex gap-4'>
                ...
                <button className='button uppercase'>Upload</button>
            </div>
            <button className='p-3 bg-slate-700 text-write rounded-lg uppercase hover:opacity-95 disabled:opacity-80 text-white'>Create Listing</button>
        </div>
    </form>
</main>
</>
